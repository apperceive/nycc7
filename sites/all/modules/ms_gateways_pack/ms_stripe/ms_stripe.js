 ...
 */
  ...
  Drupal.behaviors.stripe = function (context) {

    if (Drupal.settings.stripe.fetched == null) {
        Drupal.settings.stripe.fetched = true;
        ...
        $('#ms-stripe-payment-submit-form').submit(function(event) {
          ...
          Stripe.setPublishableKey(Drupal.settings.stripe.publicKey);
