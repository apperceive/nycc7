...
function datePicker(options) {
        ...
        o.events = {
                ...
                onkeydown: function (e) {
                        ...
                        if( kc == 13 ) {
                                // close (return)
                                var td = document.getElementById(o.id + "-date-picker-hover1");
                        ...
                        if(cacheDate.getFullYear() != o.date.getFullYear() || cacheDate.getMonth() != o.date.getMonth()) o.updateTable();
                                ...
                                for(var i = start, td; td = tds[i]; i++) {
                                        ...
                                        o.removeHighlight();
                                        td.id = o.id + "-date-picker-hover1";
                                        td.className = td.className.replace(/date-picker-hover1/g, "") + " date-picker-hover1";
                                };
                        };
                        return o.killEvent(e);
                },
                ...
                onmouseover: function(e) {
                        ...
                        this.id = o.id+"-date-picker-hover1";
                        this.className = this.className.replace(/date-picker-hover1/g, "") + " date-picker-hover1";
        ...
        o.removeHighlight = function() {
                if(document.getElementById(o.id+"-date-picker-hover1")) {
                        document.getElementById(o.id+"-date-picker-hover1").className = document.getElementById(o.id+"-date-picker-hover1").className.replace("date-picker-hover1", "");
                        document.getElementById(o.id+"-date-picker-hover1").id = "";
                };
        };
        o.reset = function() {
                        ...
                        for(var col = 0; col < 7; col++) {
                                ...
                                if(i > firstColIndex && i <= (firstColIndex + dpm)) {
                                        ...
                                        if(o.outOfRange(tmpDate)) {
                                                ...
                                                if(cd == dt) {
                                                        td.setAttribute("id", o.id + "-date-picker-hover1");
                                                        cName.push("date-picker-hover1");
                                                };
												
                                                  td.setAttribute("id", o.id + " -month-wise-select" + dt);
												  
                                                cName.push("dm-" + dt + '-' + (tdm + 1) + " " + " dmy-" + dt + '-' + (tdm + 1) + '-' + tdy);
                                                td.setAttribute(c, cName.join(' '));
                                                td.setAttribute("title", datePicker.months[cm] + o.nbsp + dt + (tdm + 1) + "," + o.nbsp + cy);
                                        };
                                } else {
