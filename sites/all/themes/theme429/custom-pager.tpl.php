 ...
 */
 $review = l('return to review', 'incentives/review');
 
 // todo: only show for admin and coord
 
 if (user_access('coordinate nycc incentives') || user_access('administer nycc incentives')) {
?>

<ul class="custom-pager custom-pager-<?php print $position; ?>">
<li class="label"><b>Navigation: </b></li>
<li class="review"><?php print $review; ?></li>
